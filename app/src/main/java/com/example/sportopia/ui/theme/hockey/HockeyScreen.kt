package com.example.sportopia.ui.theme.hockey
...
@Composable
fun HockeyScreen(navController: NavHostController){
    ...
    Column(
        ...
        Column(modifier = Modifier.padding(10.dp)) {
            Text(text = "History of hockey", fontSize = 20.sp, fontWeight = FontWeight.Bold)
...
@Composable
fun HockeyScreenPreview(){

    HockeyScreen(rememberNavController())
